...
const developers = [
  ...
  {
    name: "Aurelien",
    role: "Research, Nutrition & Energy",
    quote:
  ...
  {
    name: "Adam",
    role: "Research, Recycling & Community",
    quote:
  ...
  {
    name: "Darrach",
    role: "Authentication & Scrum Master",
  ...
  {
    name: "Marlon",
    role: "UI, UX, Semantics & Performance",
    quote:
  ...
  {
    name: "Shane",
    role: "Energy and Automated Assistance",
    quote:
